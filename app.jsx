...
function ProspectToolPage() {
  ...
  const DEFAULT_VISIBLE_COLUMNS = ['rank', 'displayName', 'idealPartnerScore', 'partnerTierName', 'industry', 'channel_role', 'channel_segment', 'displayRevenue', 'website'];
      ...
      <aside className="prospect-drawer" role="dialog" aria-modal="true" aria-label={`Partner details for ${selected.displayName}`}>
        <div className="prospect-drawer-header">
          ...
          <div className="prospect-drawer-actions">
            ...
            <IconButton icon="export" label="Download to CSV" onClick={() => exportRows([selected], `${selected.id}-prospect.csv`)} />
